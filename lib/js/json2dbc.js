            ...
            switch (obj[obj_index].type)
            {
                ...
                case 1:
                    ...
                    else
                    {
                        ...
                        template += ` SG_ INPUT_MODE_CH1 : ${Bytestart}|1@0+ (1,0) [0|5] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_MODE_CH2 : ${Bytestart + 12}|1@0+ (1,0) [0|5] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_MODE_CH3 : ${Bytestart + 8}|1@0+ (1,0) [0|5] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_DATA_CH1 : ${Bytestart + 16}|1@0+ (1,0) [0|65535] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_DATA_CH2 : ${Bytestart + 32}|1@0+ (1,0) [0|65535] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_DATA_CH3 : ${Bytestart + 48}|1@0+ (1,0) [0|65535] "" Vector__XXX\n`;

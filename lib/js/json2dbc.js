        ...
        for(let i = 0; i < arb_index_length; i++)
        {
            ...
            switch (obj[obj_index].type)
            {
                ...
                case 4:
                    ...
                    template += `BO_ ${arbid} ${device_description.aout}_${obj[obj_index]['deviceID']}_Bank${bank_main_value}: ${byte_size} Vector__XXX\n`;
                    ...
                    template += ` SG_ ${bank_main}_OUT_CH1 : ${(objdata["ByteStart"] * 8) + 8}|16@1+ (1,0) [${device_description.aout_min_max}] "${device_description.power_unit}" Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_OUT_CH2 : ${(objdata["ByteStart"] * 8) + 24}|16@1+ (1,0) [${device_description.aout_min_max}] "${device_description.power_unit}" Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_OUT_CH3 : ${(objdata["ByteStart"] * 8) + 40}|16@1+ (1,0) [${device_description.aout_min_max}] "${device_description.power_unit}" Vector__XXX\n`;
            ...
            for(let j = 0; j < sg_index_length; j++)
            {
                ...
                switch (obj[sub_obj_index].type)
                {
                    ...
                    case 4:
                        ...
                        template += ` SG_ ${bank_sub}_OUT_CH1 : ${(sub_objdata["ByteStart"] * 8) + 8}|16@1+ (1,0) [${device_description.aout_min_max}] "${device_description.power_unit}" Vector__XXX\n`;
                        template += ` SG_ ${bank_sub}_OUT_CH2 : ${(sub_objdata["ByteStart"] * 8) + 24}|16@1+ (1,0) [${device_description.aout_min_max}] "${device_description.power_unit}" Vector__XXX\n`;
                        template += ` SG_ ${bank_sub}_OUT_CH3 : ${(sub_objdata["ByteStart"] * 8) + 40}|16@1+ (1,0) [${device_description.aout_min_max}] "${device_description.power_unit}" Vector__XXX\n`;

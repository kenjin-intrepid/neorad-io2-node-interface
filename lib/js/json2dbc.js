...
const dio_val_table =
`VAL_TABLE_ Channel_Output 0 "Channel 1" 1 "Channel 2" ;
VAL_TABLE_ Output_Config 0 "Disable" 1 "Digital" 2 "PWM" 3 "Oneshot Pulse" ;
VAL_TABLE_ Output_State 0 "HighZ" 1 "Low Reverse" 2 "High Forward" 3 "Brake" ;
VAL_TABLE_ Invert 0 "Idle Low" 1 "Idle High" ;
VAL_TABLE_ HBrigde 0 "Outputs independent" 1 "Outputs Linked" ;
VAL_TABLE_ INPUT_MODE_CH1 0 "Disable" 1 "Digital" 2 "PWM" 3 "Period" 4 "Frequency" 5 "Analog" ;
VAL_TABLE_ INPUT_MODE_CH2 0 "Disable" 1 "Digital" 2 "PWM" 3 "Period" 4 "Frequency" 5 "Analog" ;
VAL_TABLE_ INPUT_MODE_CH3 0 "Disable" 1 "Digital" 2 "PWM" 3 "Period" 4 "Frequency" 5 "Analog" ;
`
        ...
        for(let i = 0; i < arb_index_length; i++)
        {
            ...
            switch (obj[obj_index].type)
            {
                case 0:
                    ...
                    template += `BO_ ${arbid} ${device_description.tc}_${obj[obj_index]['deviceID']}_Bank${bank_main_value}: ${byte_size} Vector__XXX\n`;
                    template += SG_;
                ...
                case 1:
                    ...
                    {
                        switch (parseInt(objdata["dout_mode_ch1"]))
                        {
                            case 2:
                                template += `BO_ ${arbid} ${obj[obj_index]['deviceID']}_Bank${bank_main_value}_DigitalOUT: ${byte_size} Vector__XXX\n`;
                                template += ` SG_ Channel_Output : ${Bytestart}|1@0+ (1,0) [0|1] "" Vector__XXX\n`;
                                ...
                                template += ` SG_ Duty : ${Bytestart + 8}|8@1+ (1,0) [0|255] "%" Vector__XXX\n`;
                                template += ` SG_ Frequency : ${Bytestart + 16}|16@1+ (1,0) [0|65535] "Hz" Vector__XXX\n`;
                                break;
                            case 3:
                                template += `BO_ ${arbid} ${obj[obj_index]['deviceID']}_Bank${bank_main_value}_DigitalOUT: ${byte_size} Vector__XXX\n`;
                                template += ` SG_ Channel_Output : ${Bytestart}|1@0+ (1,0) [0|1] "" Vector__XXX\n`;
                                ...
                                template += ` SG_ Invert : ${Bytestart + 6}|1@0+ (1,0) [0|1] "" Vector__XXX\n`;
                                template += ` SG_ HBrigde : ${Bytestart + 7}|1@0+ (1,0) [0|1] "" Vector__XXX\n`;
                                template += ` SG_ Period : ${Bytestart + 8}|16@1+ (1,0) [0|65535] "" Vector__XXX\n`;
                                break;
                            default:
                                template += `BO_ ${arbid} ${obj[obj_index]['deviceID']}_Bank${bank_main_value}_DigitalOUT: ${byte_size} Vector__XXX\n`;
                                template += ` SG_ Channel_Output : ${Bytestart}|1@0+ (1,0) [0|1] "" Vector__XXX\n`;
                        ...
                        dio_sig_temp += `\nBA_ "SignalType" SG_ ${arbid} Channel_Output "ENM";`;
                        ...
                        dio_val_temp += `\nVAL_ ${arbid} Channel_Output 0 "Channel 1" 1 "Channel 2" ;`;
                    ...
                    {
                        template += `BO_ ${arbid} ${obj[obj_index]['deviceID']}_Bank${bank_main_value}_DigitalIN: ${byte_size} Vector__XXX\n`;
                        template += ` SG_ SET_INPUT_MODE_CH1 : ${Bytestart + 7}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ SET_INPUT_MODE_CH2 : ${Bytestart + 6}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ SET_INPUT_MODE_CH3 : ${Bytestart + 5}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ STORE_MODES : ${Bytestart + 4}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_MODE_CH1 : ${Bytestart}|4@1+ (1,0) [0|5] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_MODE_CH2 : ${Bytestart + 12}|4@1+ (1,0) [0|5] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_MODE_CH3 : ${Bytestart + 8}|4@1+ (1,0) [0|5] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_DATA_CH1 : ${Bytestart + 16}|16@1+ (1,0) [0|65535] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_DATA_CH2 : ${Bytestart + 32}|16@1+ (1,0) [0|65535] "" Vector__XXX\n`;
                        template += ` SG_ INPUT_DATA_CH3 : ${Bytestart + 48}|16@1+ (1,0) [0|65535] "" Vector__XXX\n`;

                        dio_sig_temp += `\nBA_ "SignalType" SG_ ${arbid} INPUT_MODE_CH1 "ENM";`;
                        dio_sig_temp += `\nBA_ "SignalType" SG_ ${arbid} INPUT_MODE_CH2 "ENM";`;
                        dio_sig_temp += `\nBA_ "SignalType" SG_ ${arbid} INPUT_MODE_CH3 "ENM";`;

                        dio_val_temp += `\nVAL_ ${arbid} INPUT_MODE_CH1 0 "Disable" 1 "Digital" 2 "PWM" 3 "Period" 4 "Frequency" 5 "Analog" ;`;
                        dio_val_temp += `\nVAL_ ${arbid} INPUT_MODE_CH2 0 "Disable" 1 "Digital" 2 "PWM" 3 "Period" 4 "Frequency" 5 "Analog" ;`;
                        dio_val_temp += `\nVAL_ ${arbid} INPUT_MODE_CH3 0 "Disable" 1 "Digital" 2 "PWM" 3 "Period" 4 "Frequency" 5 "Analog" ;`;
                    }
                    break;
                case 2:
                    ...
                    for(let i = 1; i < 9; i++)
                    {
                        template += `BO_ ${arbid} ${device_description.pwrrly}_${obj[obj_index]['deviceID']}_RelayON${i}: 2 Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask8 : ${(objdata["ByteStart"] * 8) + 7}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask7 : ${(objdata["ByteStart"] * 8) + 6}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask6 : ${(objdata["ByteStart"] * 8) + 5}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask5 : ${(objdata["ByteStart"] * 8) + 4}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask4 : ${(objdata["ByteStart"] * 8) + 3}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask3 : ${(objdata["ByteStart"] * 8) + 2}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask2 : ${(objdata["ByteStart"] * 8) + 1}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask1 : ${(objdata["ByteStart"] * 8) + 0}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Relay8 : ${(objdata["ByteStart"] * 8) + 15}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Relay7 : ${(objdata["ByteStart"] * 8) + 14}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Relay6 : ${(objdata["ByteStart"] * 8) + 13}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Relay5 : ${(objdata["ByteStart"] * 8) + 12}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Relay4 : ${(objdata["ByteStart"] * 8) + 11}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Relay3 : ${(objdata["ByteStart"] * 8) + 10}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Relay2 : ${(objdata["ByteStart"] * 8) + 9}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Relay1 : ${(objdata["ByteStart"] * 8) + 8}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += "\n";
                    }

                    for(let j = 1; j < 9; j++)
                    {
                        template += `BO_ ${arbid} ${device_description.pwrrly}_${obj[obj_index]['deviceID']}_RelayOFF${j}: 2 Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask8 : ${(objdata["ByteStart"] * 8) + 7}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask7 : ${(objdata["ByteStart"] * 8) + 6}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask6 : ${(objdata["ByteStart"] * 8) + 5}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                        template += ` SG_ ${bank_main}_Mask5 : ${(objdata["ByteStart"] * 8) + 4}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                    ...
                    template += `BO_ ${arbid} ${device_description.pwrrly}_${obj[obj_index]['deviceID']}: 2 Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_Mask : ${(objdata["ByteStart"] * 8) + 7}|8@0+ (1,0) [0|255] "" Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_Relay1 : ${(objdata["ByteStart"] * 8) + 8}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_Relay2 : ${(objdata["ByteStart"] * 8) + 9}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_Relay3 : ${(objdata["ByteStart"] * 8) + 10}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_Relay4 : ${(objdata["ByteStart"] * 8) + 11}|1@0+ (1,0) [0|0] "" Vector__XXX\n`;
                ...
                case 3:
                    ...
                    template += `BO_ ${arbid} ${device_description.ain}_${obj[obj_index]['deviceID']}_Bank${bank_main_value}: ${byte_size} Vector__XXX\n`;
                    template += SG_;
                ...
                case 4:
                    ...
                    template += `BO_ ${arbid} ${device_description.aout}_${obj[obj_index]['deviceID']}_Bank${bank_main_value}: 7 Vector__XXX\n`;
                    ...
                    template += ` SG_ ${bank_main}_OUT_CH1 : ${(objdata["ByteStart"] * 8) + 8}|16@1+ (7.629510948348211e-05,0) [0|5] "${device_description.power_unit}" Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_OUT_CH2 : ${(objdata["ByteStart"] * 8) + 24}|16@1+ (7.629510948348211e-05,0) [0|5] "${device_description.power_unit}" Vector__XXX\n`;
                    template += ` SG_ ${bank_main}_OUT_CH3 : ${(objdata["ByteStart"] * 8) + 40}|16@1+ (7.629510948348211e-05,0) [0|5] "${device_description.power_unit}" Vector__XXX\n`;
            ...
            for(let j = 0; j < sg_index_length; j++)
            {
                ...
                switch (obj[sub_obj_index].type)
                {
                    ...
                    case 1:
                        ...
                        {
                            switch (parseInt(sub_objdata["dout_mode_ch1"]))
                            {
                                case 2:
                                    template += ` SG_ Channel_Output : ${bytestart}|1@0+ (1,0) [0|1] "" Vector__XXX\n`;
                                    template += ` SG_ Output_Config : ${bytestart + 3}|3@0+ (1,0) [0|3] "" Vector__XXX\n`;
                    ...
                    case 4:
                        ...
                        template += ` SG_ ${bank_sub}_OUT_CH1 : ${(sub_objdata["ByteStart"] * 8) + 8}|16@1+ (7.629510948348211e-05,0) [0|5] "${device_description.power_unit}" Vector__XXX\n`;
                        template += ` SG_ ${bank_sub}_OUT_CH2 : ${(sub_objdata["ByteStart"] * 8) + 24}|16@1+ (7.629510948348211e-05,0) [0|5] "${device_description.power_unit}" Vector__XXX\n`;
                        template += ` SG_ ${bank_sub}_OUT_CH3 : ${(sub_objdata["ByteStart"] * 8) + 40}|16@1+ (7.629510948348211e-05,0) [0|5] "${device_description.power_unit}" Vector__XXX\n`;

                ...
                <tfoot>
                    <tr><td colspan="2">
                        <div class="form-group button-group">
                            <div class="input_selector_text offline" id="manualButton">${def_lang.setting_off}</div>
                            ...
                            <div class="input_selector_text" id="interactiveButton">${def_lang.device_group}</div>
                        </div>
                ...
                <tfoot>
                    ...
                    <td>
                        <div class="input-group input-group-sm mb-3 opacity">
                            ...
                            <input class="form-control form-control-sm can_fill_id">
                        </div>
                    </td>
                    <td>
...
function cal_row_temp(type, data, index, fCall, ain_range) {
    let can_td = '';
    let tdh_extra = '';
    let td_extra = '';
    let floatPoints = 2;
...
function append_cal_table(data, ain_range) {
    let table = "";
    ...
    for(let datapoints = 0; datapoints < data_length; datapoints++){
        ...
        {
            cal_row += cal_row_temp($('#device_serial option:selected').val(), data['data'][datapoints], i, null, ain_range);
        }

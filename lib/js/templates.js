...
function template2(obj,index) {
    ...
    switch (obj.deviceType)
    {
        case 0: deviceType = "RAD-IO2-TC";
            channelName1 = channelName2 = "Bank";
            break;
        case 1: deviceType = "RAD-IO2-DIO";
            channelName1 = "DIN";
            channelName2 = "DOUT";
            break;
        case 2: deviceType = "RAD-IO2-PWRRLY";
            channelName1 = channelName2 = "Relay";
            break;
        case 3: deviceType = "RAD-IO2-AIN";
            channelName1 = channelName2 = "Bank";
            break;
        case 4: deviceType = "RAD-IO2-AOUT";
            channelName1 = channelName2 = "Bank";
            break;
        case 5: deviceType = "RAD-IO2-CANHUB";
            break;
        case 6: deviceType = "RAD-IO2-BADGE";
            break;
    }
...
function append_cal_table(data) {
    ...
    function tableTemp(cal_rows, index){
        let header = `<th class="cal_th_header">${def_lang.cal_points}</th>`;
        if(data["type"] == "4")
        {
            header = `<th class="cal_th_header" data-channel="${index}">Channel ${index+1}</th>`
        }

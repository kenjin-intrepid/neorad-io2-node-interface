    ...
    if(obj.deviceType != 5)
    {
        returnTemplate =
            ...
            <div class="flex">
                ...
                <div>
                    <button type="button" class="btn btn-success device_save hidden">${def_lang.device_save}</button>
                    <button type="button" class="btn btn-success device_default hidden">${def_lang.device_default}</button>
                </div>
            </div>
...
function template2(obj,index) {
    ...
    switch (obj.deviceType)
    {
        ...
        case 5: deviceType = "neoRAD-IO2-CANHUB";
            break;
        case 6: deviceType = "neoRAD-IO2-BADGE";
            break;
    }

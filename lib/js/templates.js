...
const english = {
    ...
    text_firmware_soft: "Firmware Version",
    text_firmware_hard: "Hardware Version",
    ...
    can_export: "Export DBC",
    device_connect: "Find Device",
    device_reload: "Disconnect",
    device_startlog: "Go Online",
    device_stop: "Stop",
    device_save: "Save settings",
    device_group: "Group Select",
    device_default: "Default settings",
    device_setting_export: "Export settings",
    device_setting_import: "Import settings",
...
const japanese = {
    ...
    text_firmware_soft: "ファームウェアバージョン",
    text_firmware_hard: "ハードウエアバージョン",
    ...
    device_setting_export: "エクスポート設定",
    device_setting_import: "インポート設定",
    graph_temp: "温度",
    graph_update: "更新中",
    graph_start: "スタート",
    graph_pause: "一時停止",
...
const korean = {
    ...
    tab_setting: "설정",
    tab_help: "도움말",
    tab_calibration: "캘리브레이션",
    tab_dev_set: "장비 설정",
    tab_can_set: "CAN 설정",
    setting_lang: "언어",
    setting_temp: "온도 단위",
    setting_rate: "그래프 새로고침 주기(ms)",
    setting_save: "변경사항 저장",
    setting_close: "닫기",
    setting_tip: "변경 사항 적용을 위해서 재시작 필요",
    setting_plot: "모든 그래프 불러오기",
    setting_on: "On",
    setting_off: "Off",
    setting_folder: "데이터 폴더 열기",
    setting_auto_save: "자동 저장",
    setting_theme: "테마",
    setting_light: "라이트",
    setting_dark: "다크",
    text_enable: "활성화됨",
    ...
    text_logging: "로깅 중",
    text_offline: "오프라인",
    text_disc: "센서가 연결되지 않음",
    text_moreinfo: "장비 정보",
    text_sample: "샘플링 속도(ms)",
    text_tagname: "태그 이름",
    text_manufacture: "생산일",
    text_firmware_soft: "펌웨어 버전",
    text_firmware_hard: "하드웨어 버전",
    text_onlinetime: "온라인 시간",
    text_custom: "커스텀",
    text_low: "Low",
    text_high: "High",
    text_state: "초기 상태",
    ...
    can_startid: "시작 ID",
    can_export: "DBC 내보내기",
    device_connect: "장비 탐색",
    device_reload: "연결 해제",
    device_startlog: "로깅 시작",
    device_stop: "로깅 중지",
    device_save: "설정 저장",
    device_group: "그룹 선택",
    device_default: "설정 초기화",
    device_setting_export: "설정 내보내기",
    device_setting_import: "설정 불러오기",
    graph_temp: "온도",
    graph_update: "그래프 업데이트 중",
    graph_start: "시작",
    graph_pause: "일시 정지",
    graph_plot: "그래프",
    graph_current: "현재",
    ...
    cal_import: "불러오기",
    cal_clear: "지우기",
    cal_interactive: "인터렉티브",
    cal_manual: "수동",
    cal_stored: "저장됨",
    cal_measured: "측정됨",
    cal_error: "에러",
    cal_points: "캘리브레이션 포인트"
};
...
const chinese = {
    ...
    text_firmware_soft: "固件版本",
    text_firmware_hard: "硬件版本",
    ...
    device_group: "全选",
    device_default: "默认设置",
    device_setting_export: "导出设置",
    device_setting_import: "导入设置",
    graph_temp: "温度",
    graph_update: "更新中",
    graph_start: "开始",
    graph_pause: "暂停",
...
const Tchinese = {
    ...
    device_group: "全選",
    device_default: "默認設置",
    device_setting_export: "導出設置",
    device_setting_import: "導入設置",
    graph_temp: "溫度",
    graph_update: "更新中",
    graph_start: "開始",
    graph_pause: "暫停",
...
function template1(obj,index) {
            ...
            <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                ...
                <div class="form-group neorad_can_id">
                    ...
                    <div class="input-group input-group-sm mb-3 opacity">
                        ...
                        <input class="form-control form-control-sm device_check_status ma_device_can_id" placeholder="Hex Value">
                        <div class="can_id_alert"></div>
                    </div>
                </div>
                <div class="form-group neorad_can_msg">
                    <label>${def_lang.can_byte}:</label>
                    <input class="form-control form-control-sm device_check_status ma_device_can_byte" placeholder="${def_lang.can_byte}">
    ...
    function ain_template(i) {
        let chain_id = obj.chainID;
        let _ain_template = `
            <div class="form-group neorad_ain_sample">
                <div class="form-check form-check-inline">
                    <input class="form-check-input neorad_ain_sample_input group_select_ain_radio" type="radio" name="ain_${chain_id}_${index}_b${i}" id="ain_low_${chain_id}_${index}_b${i}" value="low" checked>
                    <label class="form-check-label" for="ain_low_${chain_id}_${index}_b${i}">${def_lang.text_low}</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input neorad_ain_sample_input group_select_ain_radio" type="radio" name="ain_${chain_id}_${index}_b${i}" id="ain_high_${chain_id}_${index}_b${i}" value="high">
                    <label class="form-check-label" for="ain_high_${chain_id}_${index}_b${i}">${def_lang.text_high}</label>
                </div>
                <select class="form-control form-control-sm ain_select ain_low_select group_select_ain_select" id="ain_low_select_${chain_id}_${index}_b${i}">
                    <option value="1">&#177 250 mV</option>
                    <option value="2">&#177 1000 mV</option>
                    <option value="3">&#177 5000 mV</option>
                </select>
                <select class="form-control form-control-sm hidden ain_select ain_high_select group_select_ain_select" id="ain_high_select_${chain_id}_${index}_b${i}">
                    <option value="4">&#177 10 V</option>
                    <option value="5">&#177 20 V</option>
                    <option value="6">&#177 45 V</option>
                </select>
            </div>
        `;
    ...
    function rly_template(i) {
        if(i == 1)
        {
            ...
            <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                ...
                <div class="form-group neorad_rly_state">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input neorad_rly_input" type="radio" name="rly_${index}_${i}" id="rly_off_${index}_${i}" value="0" checked>
                        <label class="form-check-label" for="rly_off_${index}_${i}">${def_lang.setting_off}</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input neorad_rly_input" type="radio" name="rly_${index}_${i}" id="rly_on_${index}_${i}" value="1">
        ...
        else
        {
            ...
            <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                <div class="form-group neorad_tag">
                    <label for="device_check_tag${index}_${i}">${def_lang.text_tagname}:</label>
                    <input class="form-control form-control-sm ma_device_channel_tag" id="device_check_tag${index}_${i}" maxlength="14" pattern="[a-zA-Z0-9]" data-checkbox="device${index+1}_ch${i}" tabindex="${index * 8 + i}" disabled>
                </div>
                <div class="form-group neorad_rly_state">
                    <label>${def_lang.text_state}:</label>
                    <div class="form-check form-check-inline">
    ...
    function aout_template(i) {
        return `
            <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                ...
                <div class="input-group input-group-sm mb-3 opacity">
                    <input class="form-control form-control-sm neorad_aout_initinput_1" type="number" step="0.001" placeholder="Channel 1">
                    <div class="input-group-prepend">
                ...
                <label>${def_lang.text_ivoltage}</label>
                <div class="input-group input-group-sm mb-3 opacity">
                    <input class="form-control form-control-sm neorad_aout_initinput_2"  type="number" step="0.001" placeholder="Channel 2">
                    <div class="input-group-prepend">
                        <label class="input-group-text form-control-sm">V</label>
                    </div>
                </div>
                ...
                <label>${def_lang.text_ivoltage}</label>
                <div class="input-group input-group-sm mb-3 opacity">
                    <input class="form-control form-control-sm neorad_aout_initinput_3" type="number" step="0.001" placeholder="Channel 3">
                    <div class="input-group-prepend">
                        <label class="input-group-text form-control-sm">V</label>
                    </div>
                </div>
            ...
            for (let i = 1; i < 9; i++)
            {
                ...
                <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                    <div>
                        ...
                        <div class="input_selector_bg input_selector_bg_pwrl" id="input_selector_bg_${index}_${i}" data-index="${Math.pow(2, i-1)}">
    ...
    else
    {
        returnTemplate =
            ...
            <div class="flex">
                ...
                <div>
                    <button type="button" class="btn btn-success device_save_canhub" tabindex="-1" data-toggle="tooltip" data-placement="top" title="${def_lang.device_save}"><i class="fas fa-save"></i></button>
                </div>
            </div>
...
function template2(obj,usbIndex,device) {
    let deviceType, channelName1, channelName2;
    switch (obj.deviceType)
    {
        case 0: deviceType = "RAD-IO2-TC";
            channelName1 = channelName2 = "Bank";
            break;
        case 3: deviceType = "RAD-IO2-AIN";
            channelName1 = channelName2 = "Bank";
            break;
    }

    if(obj.deviceType == 0 || obj.deviceType == 3)
    {
        let template_td = "";
        for (let i = 1; i < 9; i++)
        {
            if(obj['enables'][`channel${i-1}`]['settingsEnables'] > "0")
            {
                ...
                <div class="form-check flex_no_align">
                    <input type="checkbox" class="form-check-input cb_device_checkbox" id="gsb_${usbIndex}_${device}_${i}" data-checkbox="device${device+1}_ch${i}" checked disabled>
                    <label for="gsb_${usbIndex}_${device}_${i}" class="form-check-label">${channelName1}${i}</label>
                    <span class="online" id="gsbData_${usbIndex}_${device}_${i}"></span>
                </div>
            `
            }
            else
...
function cal_row_temp(type, data, index, fCall, data_index) {
    let can_td = '';
    let tdh_extra = '';
    let td_extra = '';
    let cal_index = "";
    ...
    switch (type)
    {
        case "0":
            if(cal_index && cal_index != "0")
            {
                ...
                cal_index = parseFloat(cal_index.toFixed(1));
            }
            tdh_extra = `<input type="number" class="cal_input_th em15" value="${cal_index}" min="-200" max="1372" ${cal_index ? "disabled" : "enabled"}> &#176C`;
            break;
        case "3":
            if(cal_index && cal_index != "0")
            {
                ...
                cal_index = parseFloat(cal_index.toFixed(4));
            }

            if(data_index < 3)
            {
                tdh_extra = `<input type="number" class="cal_input_th em15" value="${cal_index * 1000}" ${cal_index ? "disabled" : "enabled"}> mV`;
            }
            else
            {
                tdh_extra = `<input type="number" class="cal_input_th em15" value="${cal_index}" ${cal_index ? "disabled" : "enabled"}> V`;
            }
            break;
    }
    ...
    for(let i = 1; i < 9; i++)
    {
        ...
        if(data !== null && index !== null)
        {
            ...
            {
                case "0":
                    value = parseFloat(data['datapoints'][i-1][index]).toFixed(1);
                    break;
                case "3":
                    if(data_index < 3)
                    {
                        value = parseFloat((parseFloat(data['datapoints'][i-1][index]) * 1000)).toFixed(3);
                    }
                    else
                    {
                        value = parseFloat(data['datapoints'][i-1][index]).toFixed(4);
                    }
                    break;
            }
        }
        ...
        <td>
            <div class="flex">
                <input class="cal_input cal_stored em1" disabled placeholder="${def_lang.cal_stored}" value="${value}">
                <input class="cal_input cal_me em1" placeholder="Enter Here" data-bank="${i}" value="${value}">
                <input class="cal_input cal_diff em1" disabled>
            </div>
        </td>
    `;
    }
...
function append_cal_table(data) {
    ...
    function tableTemp(cal_rows, index){
        return `
        <table class="table table-striped cal_table_ hidden" id="cal_table_${index + 1}" data-type="${data['type']}" data-range="${index + 1}">
            <thead class="thead-dark">
            <tr>
    ...
    for(let datapoints = 0; datapoints < data_length; datapoints++){
        ...
        {
            cal_row += cal_row_temp($('#device_serial option:selected').val(), data['data'][datapoints], i, null, datapoints);
        }
...
function cal_row_aout_temp(data, index, fCall) {
    let can_td = '';
    let td_extra = '';
    let cal_index = '';
    ...
    if(cal_index && cal_index != "0")
    {
        ...
        cal_index = parseFloat((cal_index).toFixed(5));
    }
    let tdh_extra = `<input type="number" class="cal_input_th em15" value="${cal_index}" ${cal_index ? "disabled" : "enabled"}> V`;
    ...
    for(let i = 1; i < 4; i++)
    {
        ...
        if(data !== null && index !== null)
        {
            if(data == undefined || data[i-1] == undefined)
            {
                console.log(data);
                return
            }

            value = parseFloat((data[i-1][index]).toFixed(5));
        }
        ...
        <td>
            <div class="flex">
                <input class="cal_input cal_stored em1" disabled placeholder="${def_lang.cal_stored}" value="${value}">
                <input class="cal_input cal_me em1" placeholder="Enter Here" data-channel="${i}" value="${value}">
                <input class="cal_input cal_diff em1" disabled>
            </div>
        </td>
    `;
...
function append_cal_table_aout(data) {
    function tableTemp(cal_rows, index){
        return `
        <table class="table table-striped cal_table_ hidden" id="cal_table_${index}" data-type="${data['type']}" data-bank="${index}">
            <thead class="thead-dark">
            <tr>
                <th class="cal_th_header" data-channel="${index}">Bank ${index+1}</th>
                <th>
            ...
            <tr>
                <td>
                    <i class="fas fa-plus-square hidden" onclick="addRowAout(${index})"></i>
                </td>
                <td></td>
                <td colspan="3"></td>
            </tr>
    ...
    {
        dataNew[bank] = [];
        for(let channel = 0; channel < data_length; channel++)
        {
            dataNew[bank][channel] = [];
            let datapoints_length = data['data'][channel]['calpoints'].length;
            dataNew[bank]["points"] = data['data'][channel]['calpoints'];
            for(let i = 0; i < datapoints_length; i++)
            {
                dataNew[bank][channel][i] = data['data'][channel]['datapoints'][bank][i];
            }
        }
    }
    ...
    {
        let cal_row = "";
        let datapoints_length = dataNew[bank]["points"].length;
        for(let i = 0; i < datapoints_length; i++)
        {
            cal_row += cal_row_aout_temp(dataNew[bank], i);
        }
        table += tableTemp(cal_row, bank);
    }

    return table;
}

function import_cal_table_aout(data) {
    function tableTemp(cal_rows, index){
        return `
        <table class="table table-striped cal_table_ hidden" id="cal_table_${index}" data-type="${data['type']}" data-bank="${index}">
            <thead class="thead-dark">
    ...
    let data_length = Object.keys(data['data']).length;
    let dataNew = {};
    for (let bank = 0; bank < data_length; bank++)
    {
        dataNew[bank] = [];
        let datapoints_length = data['data'][bank]['calpoints'].length;
        dataNew[bank]["points"] = data['data'][bank]['calpoints'];
        ...
        for(let channel = 0; channel < 3; channel++)
        {
            ...
            for(let i = 0; i < datapoints_length; i++)
            {
                dataNew[bank][channel][i] = data['data'][bank]['datapoints'][channel][i];
            }
        }
    }

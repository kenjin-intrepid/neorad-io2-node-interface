...
$('.input-group-text[for="crash_select"]').text(def_lang.setting_rate);
$('.input-group-text[for="auto_save"]').text(def_lang.setting_plot);
        ...
        let _ain_template = `
            <div class="form-group neorad_ain_sample">
                ...
                <select class="form-control form-control-sm hidden ain_select ain_high_select group_select_ain_select" id="ain_high_select_${index}_b${i}">
                    <option value="4">&#177 8 V</option>
                    <option value="5">&#177 16 V</option>
                    <option value="6">&#177 42 V</option>
                </select>
            </div>
        `;
    ...
    function aout_template(i) {
        return `
            <td class="device_channel${i}" data-device="ma_device_c${i}">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input device_check_status" id="aout_checkbox1_${index}_${i}" data-check="${i}" checked>
                    <label class="form-check-label ma_device_channel_status" for="aout_checkbox1_${index}_${i}">${def_lang.text_enable}</label>
                </div>
                <div class="input-group input-group-sm mb-3 opacity">
                    <input class="form-control form-control-sm" type="number" step="0.1" placeholder="Channel 1" disabled>
                    <div class="input-group-prepend">
                ...
                <hr>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input device_check_status" id="aout_checkbox2_${index}_${i}" data-check="${i}" checked>
                    <label class="form-check-label ma_device_channel_status" for="aout_checkbox2_${index}_${i}">${def_lang.text_enable}</label>
                </div>
                <div class="input-group input-group-sm mb-3 opacity">
                    <input class="form-control form-control-sm" type="number" step="0.1" placeholder="Channel 2" disabled>
                    <div class="input-group-prepend">
                        <label class="input-group-text form-control-sm">V</label>
                    </div>
                </div>
                <hr>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input device_check_status" id="aout_checkbox3_${index}_${i}" data-check="${i}" checked>
                    <label class="form-check-label ma_device_channel_status" for="aout_checkbox3_${index}_${i}">${def_lang.text_enable}</label>
                </div>
                <div class="input-group input-group-sm mb-3 opacity">
                    <input class="form-control form-control-sm" type="number" step="0.1" placeholder="Channel 3" disabled>
                    <div class="input-group-prepend">
                        <label class="input-group-text form-control-sm">V</label>
                    </div>
                </div>
    ...
    switch (obj.deviceType)
    {
        ...
        case 2:
            ...
            for (let i = 1; i < 9; i++)
            {
                temp_template += `
                <td class="device_channel${i}" data-device="ma_device_c${i}">
                    <div class="form-group neorad_temp">
                        <div class="ma_device_channel_set ma_device_channel_temp em15"></div>
                    </div>
                    <div>
        ...
        case 4:
            ...
            for (let i = 1; i < 9; i++)
            {
                ...
                <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                    ...
                    <div class="input-group input-group-sm mb-3 opacity">
                        <input class="form-control form-control-sm neorad_aout_input neorad_aout_input_1" type="number" step="0.1" placeholder="Channel 1">
                        <div class="input-group-prepend">
                            <label class="input-group-text form-control-sm">V</label>
                        </div>
                    </div>
                    <div class="input-group input-group-sm mb-3 opacity">
                        <input class="form-control form-control-sm neorad_aout_input neorad_aout_input_2" type="number" step="0.1" placeholder="Channel 2">
                        <div class="input-group-prepend">
                            <label class="input-group-text form-control-sm">V</label>
                        </div>
                    </div>
                    <div class="input-group input-group-sm mb-3 opacity">
                        <input class="form-control form-control-sm neorad_aout_input neorad_aout_input_3" type="number" step="0.1" placeholder="Channel 3">
                        <div class="input-group-prepend">
                            <label class="input-group-text form-control-sm">V</label>
                        </div>
                    </div>
    ...
    if(obj.deviceType != 5)
    {
        returnTemplate =
            ...
            <div class="flex">
                ...
                <div>
                    <button type="button" class="btn btn-success device_save">${def_lang.device_save}</button>
                    <button type="button" class="btn btn-success device_default">${def_lang.device_default}</button>
                </div>
            </div>
            ...
            <table class="table table2 hidden">
                ...
                <tfoot>
                    ...
                    <td><button type="button" class="btn btn-info btn-sm device_group disabled">${def_lang.setting_off}</button></td>
...
function template2(obj,index) {
    ...
    switch (obj.deviceType)
    {
        case 0: deviceType = "neoRAD-IO2-TC";
            channelName1 = channelName2 = "Bank";
            break;
        case 1: deviceType = "neoRAD-IO2-DIO";
            channelName1 = "DIN";
            channelName2 = "DOUT";
            break;
...
function cal_row_temp(type, data, index, fCall) {
    ...
    switch (type)
    {
        case "0":
            if(cal_index && cal_index != "0")
            {
                ...
                cal_index = parseFloat(cal_index.toFixed(2));
            }
    ...
    for(let i = 1; i < 9; i++)
    {
        ...
        if(data !== null && index !== null)
        {
            ...
            value = parseFloat(data['datapoints'][i-1]['datapoints'][index].toFixed(floatPoints));
        }
        can_td += `
            <td>
                <div class="flex">
...
function append_cal_table(data) {
    ...
    for(let datapoints = 0; datapoints < Object.keys(data['data']).length; datapoints++){
        let cal_row = "";

        for(let i = 0; i < data['data'][datapoints]['calpoints'].length; i++)
        {

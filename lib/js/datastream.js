...
function NativeConstructor(){
    ...
    returnObj.SetPwrRly = function(that,cIndex){
                ...
                for (let i = 1; i <= iloop; i++)
                {
                    ...
                    switch (type)
                    {
                        ...
                        case 1:
                            ...
                            if(i < 5)
                            {
                                let voltrig = parseFloat($(that).find(`.device_channel${i} .dio_v_trig`).val());
                                let prescaler = parseInt($(that).find(`.device_channel${i} .dio_prescaler`).val());
                                let mode1 = parseInt($(that).find(`.device_channel${i} .dio_mode_select_1`).val());
                                let mode2 = parseInt($(that).find(`.device_channel${i} .dio_mode_select_2`).val());
                                let mode3 = parseInt($(that).find(`.device_channel${i} .dio_mode_select_3`).val());
                                ...
                                // [mode, voltrig. prescaler]
                                eachBankSettings.channel1 = [mode1, parseInt(voltrig), prescaler];
                                eachBankSettings.channel2 = [mode2, parseInt(voltrig), prescaler];
                                eachBankSettings.channel3 = [mode3, parseInt(voltrig), prescaler];
                            }
                            else
                            {
                                let mode1 = parseInt($(that).find(`.device_channel${i} .dout_mode_select_1`).val());
                                let mode2 = parseInt($(that).find(`.device_channel${i} .dout_mode_select_2`).val());
                                let enable1 = $(that).find(`.device_channel${i} .device_check_status_ch1`).prop('checked');
                                let enable2 = $(that).find(`.device_channel${i} .device_check_status_ch1`).prop('checked');
                                let h_mode = $(that).find(`.device_channel${i} .device_hb_check_status`).prop('checked');
                                let freq1 = 0;
                                let freq2 = 0;
                                let data1 = parseInt($(that).find(`.device_channel${i} .ch1_dout_unit_input`).val());
                                let data2 = parseInt($(that).find(`.device_channel${i} .ch2_dout_unit_input`).val());
                                let state1 = parseInt($(that).find(`.device_channel${i} .dout_ch1_select`).val());
                                let state2 = parseInt($(that).find(`.device_channel${i} .dout_ch2_select`).val());

                                if(mode1 == 2)
                                {
                                    freq1 = parseInt($(that).find(`.device_channel${i} .dout_pwm_ch1`).val());
                                }

                                if(mode2 == 2)
                                {
                                    freq2 = parseInt($(that).find(`.device_channel${i} .dout_pwm_ch2`).val());
                                }
                                ...
                                // 3 = pwm freq
                                // 4 = state
                                eachBankSettings.channel1 = [mode1, enable1 ? 1 : 0, isNaN(data1) ? 0 : data1, freq1, state1];
                                eachBankSettings.channel2 = [mode2, enable2 ? 1 : 0, isNaN(data2) ? 0 : data2, freq2, state2];
                    ...
                    eachBankSettings.bank = i - 1;
                    eachBankSettings.enables = parseInt(check_stat);
                    eachBankSettings.reportRate = sample_stat;
                    eachBankSettings.deviceType = type;
                    eachBankSettings.deviceLink = deviceID - 1;
                    eachBankSettings.tagName = tag_json;
                    eachBankSettings.CanId = CanId;
                    eachBankSettings.CanMsgType = CanMsgToSend;
                    eachBankSettings.CanLocation = CanLocation;
                    eachBankSettings.extraSettings = ExtraArray;
    ...
    returnObj.getCanSettings = function(that){
        ...
        for (let i = 0; i < iloop; i++)
        {
            ...
            if(i < 4)
            {
                can_settings["data"][i]['bankType'] = "DigitalIN";
                can_settings["data"][i]['din_mode_ch1'] = $(that).find(`.device_channel${i+1} .dio_mode_select_1`).val();
                can_settings["data"][i]['din_mode_ch2'] = $(that).find(`.device_channel${i+1} .dio_mode_select_2`).val();
                can_settings["data"][i]['din_mode_ch3'] = $(that).find(`.device_channel${i+1} .dio_mode_select_3`).val();
            }
            else
            {
                can_settings["data"][i]['bankType'] = "DigitalOUT";
            }
                    ...
                    for (let j = 0; j < 8; j++)
                    {
                        ...
                        switch (deviceType)
                        {
                            case 1:
                                if(j < 4)
                                {
                                    let settings1_tripVoltage = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['tripVoltage'];
                                    let settings1_prescale = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['prescale'];
                                    settings1_tripVoltage = settings1_tripVoltage * 40 / 256;

                                    let settings1_mode = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['mode'];
                                    let settings2_mode = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings2']['mode'];
                                    let settings3_mode = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings3']['mode'];

                                    let settings1_invert = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['invert'];
                                    let settings2_invert = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings2']['invert'];
                                    let settings3_invert = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings3']['invert'];

                                    $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dio_v_trig`).val(settings1_tripVoltage);
                                    $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dio_prescaler`).val(settings1_prescale);

                                    $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dio_mode_select_1`).val(settings1_mode);
                                    $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dio_mode_select_2`).val(settings2_mode);
                                    $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dio_mode_select_3`).val(settings3_mode);

                                    switch (settings1_mode) {
                                        case 1:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch1_unit_label`).html("");
                                            break;
                                        case 2:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch1_unit_label`).html("%");
                                            break;
                                        case 3:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch1_unit_label`).html("ms");
                                            break;
                                        case 4:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch1_unit_label`).html("Hz");
                                            break;
                                        case 5:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch1_unit_label`).html("V");
                                            break;
                                    }

                                    switch (settings2_mode) {
                                        case 1:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch2_unit_label`).html("");
                                            break;
                                        case 2:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch2_unit_label`).html("%");
                                            break;
                                        case 3:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch2_unit_label`).html("ms");
                                            break;
                                        case 4:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch2_unit_label`).html("Hz");
                                            break;
                                        case 5:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch2_unit_label`).html("V");
                                            break;
                                    }

                                    switch (settings3_mode) {
                                        case 1:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch3_unit_label`).html("");
                                            break;
                                        case 2:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch3_unit_label`).html("%");
                                            break;
                                        case 3:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch3_unit_label`).html("ms");
                                            break;
                                        case 4:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch3_unit_label`).html("Hz");
                                            break;
                                        case 5:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch3_unit_label`).html("V");
                                            break;
                                    }
                                }
                                else
                                {
                                    let settings1_enable = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['enable'];
                                    let settings2_enable = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings2']['enable'];

                                    let settings1_hbridge = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['hbridge'];

                                    let settings1_pwm = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['pwm'];
                                    let settings2_pwm = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings2']['pwm'];

                                    let settings1_oneshot = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['oneshot'];
                                    let settings2_oneshot = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings2']['oneshot'];

                                    let settings1_freq = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['freq'];
                                    let settings2_freq = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings2']['freq'];

                                    let settings1_invert = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['invert'];
                                    let settings2_invert = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings2']['invert'];

                                    if(settings1_hbridge == 1)
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .device_hb_check_status`).prop('checked', true);
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dout_ch2_group`).addClass('hidden');
                                    }

                                    if(settings1_enable == 1)
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .device_check_status_ch1`).prop('checked', true);
                                    }
                                    else
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .device_check_status_ch1`).prop('checked', false);
                                    }

                                    if(settings2_enable == 1)
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .device_check_status_ch2`).prop('checked', true);
                                    }
                                    else
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .device_check_status_ch2`).prop('checked', false);
                                    }

                                    if(settings1_pwm == 1)
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dout_mode_select_1`).val(2);
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dout_pwm_ch1`).val(settings1_freq);
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .do_freq_input_p_ch1`).removeClass('hidden');
                                    }
                                    else if(settings1_oneshot == 1)
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dout_mode_select_1`).val(3);
                                    }

                                    if(settings2_pwm == 1)
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dout_mode_select_2`).val(2);
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dout_pwm_ch2`).val(settings2_freq);
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .do_freq_input_p_ch2`).removeClass('hidden');
                                    }
                                    else if(settings2_oneshot == 1)
                                    {
                                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .dout_mode_select_2`).val(3);
                                    }
                                }
                                break;
                            case 2:
                ...
                for (let i = 0; i < max_device; i++)
                {
                    ...
                    else if(deviceType == 1)
                    {
                        for (let j = 1; j < 5; j++)
                        {
                            ...
                            if(raw[usbKey][i][j - 1][0] != null)
                            {
                                $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch1_value`).val(Number.isInteger(raw[usbKey][i][j - 1][0]) ? raw[usbKey][i][j - 1][0] : parseFloat((raw[usbKey][i][j - 1][0]).toFixed(2)));
                            }

                            if(raw[usbKey][i][j - 1][1] != null)
                            {
                                $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch2_value`).val(Number.isInteger(raw[usbKey][i][j - 1][1]) ? raw[usbKey][i][j - 1][1] : parseFloat((raw[usbKey][i][j - 1][1]).toFixed(2)));
                            }

                            if(raw[usbKey][i][j - 1][2] != null)
                            {
                                $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch3_value`).val(Number.isInteger(raw[usbKey][i][j - 1][2]) ? raw[usbKey][i][j - 1][2] : parseFloat((raw[usbKey][i][j - 1][2]).toFixed(2)));
                            }
                        }
                    }
                }
        ...
        for(let i = 0; i < obj_length; i++)
        {
            ...
            switch (Object.values(objvalue)[i]['deviceType'])
            {
                case 1:
                    if(i < 4)
                    {
                        let settings1_mode = Object.values(objvalue)[i]['settings1']['mode'];
                        let settings2_mode = Object.values(objvalue)[i]['settings2']['mode'];
                        let settings3_mode = Object.values(objvalue)[i]['settings3']['mode'];
                        let settings1_tripVoltage = Object.values(objvalue)[i]['settings1']['tripVoltage'];
                        let settings1_prescale = Object.values(objvalue)[i]['settings1']['prescale'];
                        settings1_tripVoltage = settings1_tripVoltage * 40 / 256;

                        $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dio_v_trig`).val(settings1_tripVoltage);
                        $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dio_prescaler`).val(settings1_prescale);

                        $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dio_mode_select_1`).val(settings1_mode);
                        $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dio_mode_select_2`).val(settings2_mode);
                        $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dio_mode_select_3`).val(settings3_mode);

                        switch (settings1_mode) {
                            case 1:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch1_unit_label`).html("");
                                break;
                            case 2:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch1_unit_label`).html("%");
                                break;
                            case 3:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch1_unit_label`).html("ms");
                                break;
                            case 4:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch1_unit_label`).html("Hz");
                                break;
                            case 5:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch1_unit_label`).html("V");
                                break;
                        }

                        switch (settings2_mode) {
                            case 1:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch2_unit_label`).html("");
                                break;
                            case 2:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch2_unit_label`).html("%");
                                break;
                            case 3:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch2_unit_label`).html("ms");
                                break;
                            case 4:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch2_unit_label`).html("Hz");
                                break;
                            case 5:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch2_unit_label`).html("V");
                                break;
                        }

                        switch (settings3_mode) {
                            case 1:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch3_unit_label`).html("");
                                break;
                            case 2:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch3_unit_label`).html("%");
                                break;
                            case 3:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch3_unit_label`).html("ms");
                                break;
                            case 4:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch3_unit_label`).html("Hz");
                                break;
                            case 5:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch3_unit_label`).html("V");
                                break;
                        }
                    }
                    else
                    {
                        let settings1_enable = Object.values(objvalue)[i]['settings1']['enable'];
                        let settings2_enable = Object.values(objvalue)[i]['settings2']['enable'];

                        let settings1_hbridge = Object.values(objvalue)[i]['settings1']['hbridge'];

                        let settings1_pwm = Object.values(objvalue)[i]['settings1']['pwm'];
                        let settings2_pwm = Object.values(objvalue)[i]['settings2']['pwm'];

                        let settings1_oneshot = Object.values(objvalue)[i]['settings1']['oneshot'];
                        let settings2_oneshot = Object.values(objvalue)[i]['settings2']['oneshot'];

                        let settings1_freq = Object.values(objvalue)[i]['settings1']['freq'];
                        let settings2_freq = Object.values(objvalue)[i]['settings2']['freq'];

                        let settings1_invert = Object.values(objvalue)[i]['settings1']['invert'];
                        let settings2_invert = Object.values(objvalue)[i]['settings2']['invert'];

                        if(settings1_hbridge == 1)
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .device_hb_check_status`).prop('checked', true);
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dout_ch2_group`).addClass('hidden');
                        }
                        else
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .device_hb_check_status`).prop('checked', false);
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dout_ch2_group`).removeClass('hidden');
                        }

                        if(settings1_enable == 1)
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .device_check_status_ch1`).prop('checked', true);
                        }
                        else
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .device_check_status_ch1`).prop('checked', false);
                        }

                        if(settings2_enable == 1)
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .device_check_status_ch2`).prop('checked', true);
                        }
                        else
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .device_check_status_ch2`).prop('checked', false);
                        }

                        if(settings1_pwm == 1)
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dout_mode_select_1`).val(2);
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dout_pwm_ch1`).val(settings1_freq);
                        }
                        else if(settings1_oneshot == 1)
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dout_mode_select_1`).val(3);
                        }

                        if(settings2_pwm == 1)
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dout_mode_select_2`).val(2);
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dout_pwm_ch2`).val(settings2_freq);
                        }
                        else if(settings2_oneshot == 1)
                        {
                            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .dout_mode_select_2`).val(3);
                        }
                    }
                    break;
                case 3:
    ...
    function exportTime(time) {
        ...
        if(hour === 0)
        {
            returntime = `00:${min}:${sec},${millisec}`;
        }
        else
        {
...
$('.ma_device').on('click','.can_fill_apply',function () {
    let that = $(this);
    let type = parseInt($(this).parents('.ma_device_wrap').attr('data-type'));
            ...
            for (let i = 1; i <= iloop; i++)
            {
                ...
                switch (type)
                {
                    ...
                    case 1:
                        ...
                        if(i < 5)
                        {
                            eachBankSettings.mode1 = parseInt($(that).find(`.device_channel${i} .dio_mode_select_1`).val());
                            eachBankSettings.mode2 = parseInt($(that).find(`.device_channel${i} .dio_mode_select_2`).val());
                            eachBankSettings.mode3 = parseInt($(that).find(`.device_channel${i} .dio_mode_select_3`).val());
                            eachBankSettings.voltrig = parseFloat($(that).find(`.device_channel${i} .dio_v_trig`).val());
                            eachBankSettings.prescaler = parseInt($(that).find(`.device_channel${i} .dio_prescaler`).val());
                        }
                        else
                        {
                            let mode1 = parseInt($(that).find(`.device_channel${i} .dout_mode_select_1`).val());
                            ...
                            if(mode1 == 2)
                            {
                                eachBankSettings.freq1 = parseInt($(that).find(`.device_channel${i} .dout_pwm_ch1`).val());
                            }

                            if(mode2 == 2)
                            {
                                eachBankSettings.freq2 = parseInt($(that).find(`.device_channel${i} .dout_pwm_ch2`).val());
                            }

                            eachBankSettings.mode1 = mode1;
                            eachBankSettings.mode2 = mode2;
                            eachBankSettings.enable1 = $(that).find(`.device_channel${i} .device_check_status_ch1`).prop('checked');
                            eachBankSettings.enable2 = $(that).find(`.device_channel${i} .device_check_status_ch1`).prop('checked');
                            eachBankSettings.data1 = parseInt($(that).find(`.device_channel${i} .ch1_dout_unit_input`).val());
                            eachBankSettings.data2 = parseInt($(that).find(`.device_channel${i} .ch2_dout_unit_input`).val());
                            eachBankSettings.h_mode = $(that).find(`.device_channel${i} .device_hb_check_status`).prop('checked');
                        }
                        break;
                    case 3:
                        if (check_stat)
            ...
            for (let i = 1; i < banklength + 1; i++)
            {
                ...
                switch (dataObj["deviceType"])
                {
                    case 1:
                        if(i < 4)
                        {
                            let settings1_tripVoltage = dataObj["bank"][i-1]['voltrig'];
                            let settings1_prescale = dataObj["bank"][i-1]['prescaler'];

                            let settings1_mode = dataObj["bank"][i-1]['mode1'];
                            let settings2_mode = dataObj["bank"][i-1]['mode2'];
                            let settings3_mode = dataObj["bank"][i-1]['mode3'];

                            $(that).find(`.device_channel${i} .dio_v_trig`).val(settings1_tripVoltage);
                            $(that).find(`.device_channel${i} .dio_prescaler`).val(settings1_prescale);

                            $(that).find(`.device_channel${i} .dio_mode_select_1`).val(settings1_mode);
                            $(that).find(`.device_channel${i} .dio_mode_select_2`).val(settings2_mode);
                            $(that).find(`.device_channel${i} .dio_mode_select_3`).val(settings3_mode);

                            switch (settings1_mode) {
                                case 1:
                                    $(that).find(`.table5 .device_channel${i} .ch1_unit_label`).html("");
                                    break;
                                case 2:
                                    $(that).find(`.table5 .device_channel${i} .ch1_unit_label`).html("%");
                                    break;
                                case 3:
                                    $(that).find(`.table5 .device_channel${i} .ch1_unit_label`).html("ms");
                                    break;
                                case 4:
                                    $(that).find(`.table5 .device_channel${i} .ch1_unit_label`).html("Hz");
                                    break;
                                case 5:
                                    $(that).find(`.table5 .device_channel${i} .ch1_unit_label`).html("V");
                                    break;
                            }

                            switch (settings2_mode) {
                                case 1:
                                    $(that).find(`.table5 .device_channel${i} .ch2_unit_label`).html("");
                                    break;
                                case 2:
                                    $(that).find(`.table5 .device_channel${i} .ch2_unit_label`).html("%");
                                    break;
                                case 3:
                                    $(that).find(`.table5 .device_channel${i} .ch2_unit_label`).html("ms");
                                    break;
                                case 4:
                                    $(that).find(`.table5 .device_channel${i} .ch2_unit_label`).html("Hz");
                                    break;
                                case 5:
                                    $(that).find(`.table5 .device_channel${i} .ch2_unit_label`).html("V");
                                    break;
                            }

                            switch (settings3_mode) {
                                case 1:
                                    $(that).find(`.table5 .device_channel${i} .ch3_unit_label`).html("");
                                    break;
                                case 2:
                                    $(that).find(`.table5 .device_channel${i} .ch3_unit_label`).html("%");
                                    break;
                                case 3:
                                    $(that).find(`.table5 .device_channel${i} .ch3_unit_label`).html("ms");
                                    break;
                                case 4:
                                    $(that).find(`.table5 .device_channel${i} .ch3_unit_label`).html("Hz");
                                    break;
                                case 5:
                                    $(that).find(`.table5 .device_channel${i} .ch3_unit_label`).html("V");
                                    break;
                            }
                        }
                        else
                        {
                            let settings1 = dataObj["bank"][i-1]['mode1'];
                            let settings2 = dataObj["bank"][i-1]['mode2'];

                            let settings1_enable = dataObj["bank"][i-1]['enable1'];
                            let settings2_enable = dataObj["bank"][i-1]['enable1'];
                            let settings1_hbridge = dataObj["bank"][i-1]['h_mode'];

                            if(settings1_hbridge == true)
                            {
                                $(that).find(`.device_channel${i} .device_hb_check_status`).prop('checked', true);
                                $(that).find(`.device_channel${i} .dout_ch2_group`).addClass('hidden');
                            }

                            $(that).find(`.device_channel${i} .device_check_status_ch1`).prop('checked', settings1_enable);
                            $(that).find(`.device_channel${i} .device_check_status_ch2`).prop('checked', settings2_enable);
                            $(that).find(`.device_channel${i} .dout_mode_select_1`).val(settings1);
                            $(that).find(`.device_channel${i} .dout_mode_select_2`).val(settings2);


                            if(settings1 == 2)
                            {
                                $(that).find(`.device_channel${i} .dout_mode_select_1`).val(2);
                                $(that).find(`.device_channel${i} .dout_pwm_ch1`).val(dataObj["bank"][i-1]['freq1']);
                                $(that).find(`.device_channel${i} .do_freq_input_p_ch1`).removeClass('hidden');
                            }

                            if(settings2 == 2)
                            {
                                $(that).find(`.device_channel${i} .dout_mode_select_2`).val(2);
                                $(that).find(`.device_channel${i} .dout_pwm_ch2`).val(dataObj["bank"][i-1]['freq2']);
                                $(that).find(`.device_channel${i} .do_freq_input_p_ch2`).removeClass('hidden');
                            }
                        }
                        break;
                    case 2:
...
function saveCal() {
    ...
    dialog.showMessageBox({
        type:"warning",
        buttons:["OK","Cancel"],
        message:"Would you like to store the current values before writing?",
        cancelId: 0,
    },function (op) {
        if(!op)
        {
    ...
    if (currentValue == "0")
    {
        $(this).find('.input_selector').animate({left: (movePixel * 0.87)}, {
            ...
            complete: () => {
                ...
                if(globalObj.neoRADIO_status == 2)
                {
                    globalObj.SetPwrRly(that,currentIndex);
...
// let DoutPWMTimer;
// $('.ma_device').on('blur','.ch1_dout_unit_input',function () {
//     clearTimeout(DoutPWMTimer);
//     let that = $(this).parents('.ma_device_wrap');
//     let bank = $(this).parents('.em1').attr('data-bank');
//
//     if($(this).val() < 0 || $(this).val() > 5)
...
//     {
//         // globalObj.SetAoutValue(that, bank);
//         DoutPWMTimer = setTimeout(function () {
//             globalObj.startDataPush();
//         },100);
//     }
//     else
...
// });
//
// $('.ma_device').on('blur','.ch2_dout_unit_input',function () {
//     clearTimeout(DoutPWMTimer);
//     let that = $(this).parents('.ma_device_wrap');
//     let bank = $(this).parents('.em1').attr('data-bank');
//
...
// });
//
// $(".ma_device").on("focus",".ch1_dout_unit_input", function () {
//     $(this).select();
// });
//
// $(".ma_device").on("focus",".ch2_dout_unit_input", function () {
//     $(this).select();
// });
//
// $('.ma_device').on('keyup','.ch1_dout_unit_input',function (e) {
//     if(e.which === 13)
//     {
//
//     }
// });
//
// $('.ma_device').on('keyup','.ch2_dout_unit_input',function (e) {
//     if(e.which === 13)
//     {
//
//     }

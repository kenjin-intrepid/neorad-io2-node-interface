...
function NativeConstructor(){
    ...
    EmitEvents.from.on('device_found', device_found => {
        console.log(JSON.parse(device_found));
    ...
    EmitEvents.from.on('cal_settings', data_stream => {
        ...
        else if(data_stream && data_stream != "OK")
        {
            ...
            {
                change_status_text(`Storing in progress ${((parseInt(data_stream) + 1) * 16.6).toFixed(0)}%`);
            }
            else
            {
                change_status_text(`Storing in progress ${((parseInt(data_stream) - 9) * 12.5).toFixed(0)}%`);
            }
        }
    });
    ...
    EmitEvents.from.on('default_loaded', data_stream => {
        ...
        {
            change_status_text('Load default settings failed');
        }
    });
    ...
    function showConnected(device_found){
        ...
        for(let usbIndex = 0; usbIndex < usbDeviceLength; usbIndex++)
        {
            ...
            if (errorCode == "102")
            {
                change_status_text(`${usbKey} read failed. Please try reconnecting`);
            }
        ...
        for(let usbIndex = 0; usbIndex < usbDeviceLength; usbIndex++)
        {
            ...
            for (let i = 0; i < max_device; i++)
            {
                for (let j = 0; j < 8; j++)
                {
                    ...
                    if (EnableStatus > 0)
                    {
                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_channel_status`).text(def_lang.text_enable).prev().prop('checked', true);
                    }
                    else
                    {
                        $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_channel_status`).text(def_lang.text_disable).prev().prop('checked', false);
                    }
                    ...
                    $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_can_id`).val(`0x${canArbid.toString(16).toUpperCase()}`);
                    ...
                    switch (deviceType) {
                        ...
                        case 4:
                            ...
                            if (settings1_enable > 0)
                            {
                                ...
                                $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_channel_status1`).text(def_lang.text_enable);
                            ...
                            else
                            {
                                ...
                                $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_channel_status1`).text(def_lang.text_disable);
                            ...
                            if (settings2_enable > 0)
                            {
                                ...
                                $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_channel_status2`).text(def_lang.text_enable);
                            ...
                            else
                            {
                                ...
                                $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_channel_status2`).text(def_lang.text_disable);
                            ...
                            if (settings3_enable > 0)
                            {
                                ...
                                $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_channel_status3`).text(def_lang.text_enable);
                                ...
                                $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .ma_device_channel_status3`).text(def_lang.text_disable);
                            ...
                            $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .neorad_aout_initinput_1`).val(initOutputValue1 / 13107);
                            $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .neorad_aout_initinput_2`).val(initOutputValue2 / 13107);
                            $(`.usb${usbIndex}_device${i} .device_channel${ChipOnDevice} .neorad_aout_initinput_3`).val(initOutputValue3 / 13107);
                            break;
                        case 5:
                            break;
                    }
                ...
                for (let i = 0; i < max_device; i++)
                {
                    for (let j = 1; j < 9; j++)
                    {
                        ...
                        if (raw[usbKey][i])
                        {
                            ...
                            {
                                tempPushToArray(measured_value, i, (j - 1), exportTime(time_running));
                            }
                        }
                        ...
                        //     {
                        //         case 0:
                        //             rawObj[`usb_${usbIndex}_device${i + 1}_bank${j}`] = parseFloat(measured_value.toFixed(2));
                        //             break;
                        //         case 3:
    ...
    function reloadSettings(raw) {
        ...
        for(let i = 0; i < obj_length; i++)
        {
            ...
            if(enables == 0)
            {
                $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_status`).prev().prop('checked',false).text(def_lang.text_disable);
                $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_temp`).text("");
            }
            else if(enables == 1)
            {
                $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_status`).prev().prop('checked',true).text(def_lang.text_enable);
                $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_temp`).text("");
            }
            ...
            $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_can_id`).val(canArbid);
            ...
            if(Object.values(objvalue)[i]['deviceType'] == 4)
            {
                ...
                if(settings1_enable > 0)
                {
                    ...
                    $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_status1`).text(def_lang.text_enable);
                ...
                else
                {
                    ...
                    $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_status1`).text(def_lang.text_disable);
                ...
                if(settings2_enable > 0)
                {
                    ...
                    $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_status2`).text(def_lang.text_enable);
                ...
                else
                {
                    ...
                    $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_status2`).text(def_lang.text_disable);
                ...
                if(settings3_enable > 0)
                {
                    ...
                    $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_status3`).text(def_lang.text_enable);
                ...
                else
                {
                    ...
                    $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .ma_device_channel_status3`).text(def_lang.text_disable);
                ...
                $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .neorad_aout_initinput_1`).val(initOutputValue1 / 13107);
                $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .neorad_aout_initinput_2`).val(initOutputValue2 / 13107);
                $(`.usb${deviceSaveUSB}_device${deviceSave} .device_channel${i+1} .neorad_aout_initinput_3`).val(initOutputValue3 / 13107);
            }
        }

        // let max_device = returnObj.device_found[`usb${deviceSaveUSB}`].maxID_Device;
        // for (let i = 0; i < max_device; i++)
        // {
        //     for(let j = 0; j < 8; j++)
        //     {
        //         let EnableStatus = raw[`usb${deviceSaveUSB}`]['chainlist'][`device${i}`][`channel${j}`]['settingsEnables'];
        //         PlotSeries.enables.push(EnableStatus);
        //     }
        // }
...
$('.ma_device').on('click','.can_export',function(){
    ...
    let Obj = globalObj.getCanSettings(that);

    let file = Obj.deviceID;
    ...
    dialog.showSaveDialog({
        ...
        json2dbc.savedbc(sortObj,Obj,myPath);
    });
});

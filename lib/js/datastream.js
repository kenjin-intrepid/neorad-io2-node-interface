                    ...
                    switch (type)
                    {
                        ...
                        case 1:
                            ...
                            else
                            {
                                ...
                                let enable1 = parseInt($(that).find(`.device_channel${i} .device_check_status_ch1`).prop('checked'));
                                let enable2 = parseInt($(that).find(`.device_channel${i} .device_check_status_ch1`).prop('checked'));

                                eachBankSettings.channel1 = [mode1, enable1 ? 1 : 0];
                                eachBankSettings.channel2 = [mode2, enable2 ? 1 : 0];
                    ...
                    for (let j = 0; j < 8; j++)
                    {
                        ...
                        switch (deviceType)
                        {
                            case 1:
                                ...
                                {
                                    console.log(raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]);
                                    ...
                                    let settings1_mode = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings1']['enable'];
                                    let settings2_mode = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings2']['enable'];
        ...
        for(let i = 0; i < obj_length; i++)
        {
            ...
            switch (Object.values(objvalue)[i]['deviceType'])
            {
                case 1:
                    ...
                    {
                        let settings1_enable = Object.values(objvalue)[i]['settings2']['enable'];

                ...
                for (let i = 1; i <= iloop; i++)
                {
                    ...
                    switch (type)
                    {
                        ...
                        case 1:
                            ...
                            if(i < 5)
                            {
                                let voltrig = parseInt($(that).find(`.device_channel${i} .dio_v_trig`).val());
                                ...
                                eachBankSettings.channel1 = [mode1, voltrig, prescaler];
                                eachBankSettings.channel2 = [mode2, voltrig, prescaler];
                                eachBankSettings.channel3 = [mode3, voltrig, prescaler];
                            }
                            else
                            {
                        ...
                        switch (deviceType)
                        {
                            case 1:
                                if(j < 4)
                                {
                                    ...
                                    let settings3_enable = raw[usbKey]['chainlist'][`device${i}`][`channel${j}`]['settings3']['enable'];
                ...
                for (let i = 0; i < max_device; i++)
                {
                    ...
                    else if(deviceType == 1)
                    {
                        for (let j = 1; j < 9; j++)
                        {
                            ...
                            $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch1_value`).val(raw[usbKey][i][j - 1][0]);
                            $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch2_value`).val(raw[usbKey][i][j - 1][1]);
                            $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch3_value`).val(raw[usbKey][i][j - 1][2]);
                        }
                    }
                }
            }
...
$('.ma_device').on('keyup','.ch1_dout_unit_input',function () {
    if(e.which === 13)
    {
...
$('.ma_device').on('keyup','.ch2_dout_unit_input',function () {
    if(e.which === 13)
    {

                                ...
                                if(j < 4)
                                {
                                    ...
                                    switch (settings1_mode) {
                                        ...
                                        case 2:
                                            ...
                                            break;
                                        case 3:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch1_unit_label`).html("&#181s");
                                            break;
                                        case 4:
                                    ...
                                    switch (settings2_mode) {
                                        ...
                                        case 2:
                                            ...
                                            break;
                                        case 3:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch2_unit_label`).html("&#181s");
                                            break;
                                        case 4:
                                    ...
                                    switch (settings3_mode) {
                                        ...
                                        case 2:
                                            ...
                                            break;
                                        case 3:
                                            $(`.usb${usbIndex}_device${i} .table5 .device_channel${ChipOnDevice} .ch3_unit_label`).html("&#181s");
                                            break;
                                        case 4:
                ...
                for (let i = 0; i < max_device; i++)
                {
                    ...
                    else if(deviceType == 1)
                    {
                        for (let j = 1; j < 5; j++)
                        {
                            ...
                            {
                                $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch1_value`).val(Number.isInteger(raw[usbKey][i][j - 1][0]) ? raw[usbKey][i][j - 1][0] : parseFloat((raw[usbKey][i][j - 1][0]).toFixed(4)));
                            }

                            if(raw[usbKey][i][j - 1][1] != null)
                            {
                                $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch2_value`).val(Number.isInteger(raw[usbKey][i][j - 1][1]) ? raw[usbKey][i][j - 1][1] : parseFloat((raw[usbKey][i][j - 1][1]).toFixed(4)));
                            }

                            if(raw[usbKey][i][j - 1][2] != null)
                            {
                                $(`.usb${usbIndex}_device${i} .device_channel${j} .din_ch3_value`).val(Number.isInteger(raw[usbKey][i][j - 1][2]) ? raw[usbKey][i][j - 1][2] : parseFloat((raw[usbKey][i][j - 1][2]).toFixed(4)));
                            }
                        }
                    }
                }
                    ...
                    if(i < 4)
                    {
                        ...
                        switch (settings1_mode) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch1_unit_label`).html("&#181s");
                                break;
                            case 4:
                        ...
                        switch (settings2_mode) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch2_unit_label`).html("&#181s");
                                break;
                            case 4:
                        ...
                        switch (settings3_mode) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                $(`.usb${deviceSaveUSB}_device${deviceSave} .table5 .device_channel${i+1} .ch3_unit_label`).html("&#181s");
                                break;
                            case 4:

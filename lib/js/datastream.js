        ...
        for(let usbIndex = 0; usbIndex < usbDeviceLength; usbIndex++)
        {
            ...
            if(deviceState == 6)
            {
                ...
                for (let i = 0; i < deviceConnected; i++)
                {
                    ...
                    if(device_found[usbKey]['firmwareVersion_major'][i] < 3)
                    {
                        change_error_text(`Please update firmware for ${device_found[usbKey]['serialNumber'][i]}`);
                    }
                    else
                    {
                        if(device_found[usbKey]['firmwareVersion_minor'][i] < 19)
                        {
                            change_error_text(`Please update firmware for ${device_found[usbKey]['serialNumber'][i]}`);
                        }
                    }

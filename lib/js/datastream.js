...
function NativeConstructor(){
    ...
    EmitEvents.from.on('device_found', device_found => {
        ...
        {
            if(returnObj.device_found['usb0'].State != neoRADIO2_RunStates.neoRADIO2state_Connected)
            {
                returnObj.close();
    ...
    function showConnected(){
        let deviceConnected = returnObj.device_found['usb0'].maxID_Device;
        ...
        if(deviceConnected > 0)
        {
            ...
            {
                devices[i] = {
                    deviceType : returnObj.device_found['usb0']['chainlist'][`device${i}`]['channel0']['deviceType'],
                    serialNumber : returnObj.device_found['usb0']['serialNumber'][i],
                };
                ...
                let deviceObject = {
                    deviceType : returnObj.device_found['usb0']['chainlist'][`device${i}`]['channel0']['deviceType'],
                    serialNumber : returnObj.device_found['usb0']['serialNumber'][i],
                    manufacture_year : returnObj.device_found['usb0']['manufacture_year'][i],
                    manufacture_month : returnObj.device_found['usb0']['manufacture_month'][i],
                    manufacture_day : returnObj.device_found['usb0']['manufacture_day'][i],
                    firmwareVersion_major : returnObj.device_found['usb0']['firmwareVersion_major'][i],
                    firmwareVersion_minor : returnObj.device_found['usb0']['firmwareVersion_minor'][i],
                    hardwareRev_major : returnObj.device_found['usb0']['hardwareRev_major'][i],
                    hardwareRev_minor : returnObj.device_found['usb0']['hardwareRev_minor'][i],
                };
    ...
    function readSettings(raw) {
        if(raw['usb0'].State == neoRADIO2_RunStates.neoRADIO2state_Connected)
        {
            ...
            for (let i = 0; i < max_device; i++)
            {
                for(let j = 0; j < 8; j++)
                {
                    ...
                    let EnableStatus = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settingsEnables'];
                    let ReportRate = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settingsReportRate'];
                    let deviceType = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['deviceType'];
                    let canArbid = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settingsCanArbid'];
                    let canLocation = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settingsCanLocation'];
                    let canMsgType = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settingsCanMsgType'];
                    ...
                    let tagName = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settingsNameArray'];
                    let tagNameString = "";
                    ...
                    switch (deviceType) {
                        ...
                        case 2:
                            ...
                            if(raw['usb0']['PWRRLY_STATUS'][i])
                            {
                                let movePixel = $('.input_selector').width();
                                let bStatus = parseInt(raw['usb0']['PWRRLY_STATUS'][i]).toString(2);
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            let settings1_enable = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settings1']['enabled'];
                            let settings2_enable = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settings2']['enabled'];
                            let settings3_enable = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settings3']['enabled'];
                            ...
                            let initOutputValue1 = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settings1']['initOutputValue'];
                            let initOutputValue2 = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settings2']['initOutputValue'];
                            let initOutputValue3 = raw['usb0']['chainlist'][`device${i}`][`channel${j}`]['settings3']['initOutputValue'];
                ...
                if(raw['usb0']['chainlist'][`device${i}`]['channel0']['notInit'] == 1)
                {
    ...
    function reloadSettings(raw) {
        ...
        for(let i = 0; i < obj_length; i++)
        {
            ...
            if(Object.values(objvalue)[i]['deviceType'] == 4)
            {
                ...
                $(`.device${i} .device_channel${i+1} .neorad_aout_initinput_1`).val(initOutputValue1 / 13107);
                $(`.device${i} .device_channel${i+1} .neorad_aout_initinput_2`).val(initOutputValue2 / 13107);
                $(`.device${i} .device_channel${i+1} .neorad_aout_initinput_3`).val(initOutputValue3 / 13107);
            }
        }

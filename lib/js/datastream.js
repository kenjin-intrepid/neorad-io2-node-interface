...
$('.ma_device').on('click','.can_fill_apply',function () {
    ...
    dialog.showMessageBox({
        ...
        if(!op)
        {
            let fill_type = $(that).parents('.ma_device_wrap').find('.can_fill_select').val();
            let Startid = parseInt($(that).parents('.ma_device_wrap').find('.can_fill_id').val(),16);
            let cantype_set = $(that).parents('.ma_device_wrap').find('.auto_fill_cantype').val();
            let cantypeid_set = $(that).parents('.ma_device_wrap').find('.auto_fill_canidtype').val();

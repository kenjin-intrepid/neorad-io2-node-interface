            ...
            <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm dio_mode_select" id="dio_mode_select_1_${index}_${i}">
                        ...
                        <option value="4">Period low</option>
                        <option value="5">Period High</option>
                        <option value="6">Analog</option>
                    </select>
                    <div class="input-group input-group-sm mb-3 opacity">
    ...
    function dout_template(i) {
        return `
            <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                ...
                <div class="form-group">
                    <label for="hbridge_select${index}_${i}">H bridge:</label>
                    <select class="form-control form-control-sm hbridge_select" id="hbridge_select${index}_${i}">
                        <option value="1">Off</option>
                        <option value="2">On</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm hbridge_mode_select" id="hbridge_mode_select${index}_${i}" disabled>
...
dio_template.events = function(){
    ...
    $(".ma_device").on('change', '.hbridge_select',function () {
        if($(this).val() == "1")
        {
            $(this).parents('td').find('.hbridge_mode_select').prop('disabled',true);
            $(this).parents('td').find('.dout_ch1_select').prop('disabled',false);
            $(this).parents('td').find('.dout_ch2_select').prop('disabled',false);
        }
        else if($(this).val() == "2")
        {
            $(this).parents('td').find('.hbridge_mode_select').prop('disabled',false);
            $(this).parents('td').find('.dout_ch1_select').prop('disabled',true);
            $(this).parents('td').find('.dout_ch2_select').prop('disabled',true);
        }
    });

    ...
    function din_channel_template(i,number)
    {
        return `
            <div class="form-group">
                ...
                <select class="form-control form-control-sm dio_mode_select" id="dio_mode_select_${number}_${index}_${i}" data-bank="${i}" data-channel="${number}">
            ...
            <td class="device_channel${i} em1" data-device="ma_device_c${i}">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm mb-3 opacity">
                            <input type="number" class="form-control form-control-sm" id="dio_v_trig_${index}_${i}">
                            <div class="input-group-prepend">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-sm mb-3 opacity">
                            <input type="number" class="form-control form-control-sm" id="dio_prescaler_${index}_${i}">
<!--                            <div class="input-group-prepend">-->
        ...
        return `
            <td class="device_channel${i} dout_channels em1" data-device="ma_device_c${i}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm dout_mode_select" id="dout_mode_select${index}_${i}_1" data-bank="${i}" data-channel="1">
                        <option value="1">Digital</option>
                        <option value="2">PWM</option>
                        <option value="3">Period</option>
                    </select>
                    
                    <div class="input-group input-group-sm mb-3 opacity do_freq_input_p hidden">
                        <input class="form-control form-control-sm dout_pwm">
                        <div class="input-group-prepend">
                            <label class="input-group-text form-control-sm">Hz</label>
                        </div>
                    </div>
                ...
                <div class="dout_ch2_group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm dout_mode_select" id="dout_mode_select${index}_${i}_2" data-bank="${i}" data-channel="2">
                            <option value="1">Digital</option>
                            <option value="2">PWM</option>
                            <option value="3">Period</option>
                        </select>
        ...
        if(i < 5)
        {
            ...
            temp_template += `
                <td class="device_channel${i} em1" data-device="ma_device_c${i}" data-bank="${i}">
                    ...
                    <div class="input-group input-group-sm mb-3 opacity">
                        <input class="form-control form-control-sm" placeholder="Ch 1" disabled>
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group input-group-sm mb-3 opacity">
                        <input class="form-control form-control-sm" placeholder="Ch 2" disabled>
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group input-group-sm mb-3 opacity">
                        <input class="form-control form-control-sm" placeholder="Ch 3" disabled>
                        <div class="input-group-prepend">
                ...
                <td class="device_channel${i} em1" data-device="ma_device_c${i}" data-bank="${i}">
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm dout_ch1_select" id="dout_ch1_select${index}_${i}">
                            <option value="1">HIZ</option>
                            <option value="2">Low reverse</option>
                            <option value="3">High forward</option>
                    ...
                    <div class="ch1_dout_input_group hidden">
                        <label>Channel 1</label>
                        <div class="input-group input-group-sm mb-3 opacity">
                            <input class="form-control form-control-sm" type="number" step="0.001" placeholder="Ch 1">
                            <div class="input-group-prepend">
                    ...
                    <div class="dout_ch2_group">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm dout_ch1_select" id="dout_ch2_select${index}_${i}">
                                <option value="1">HIZ</option>
                                <option value="2">Low reverse</option>
                                <option value="3">High forward</option>
                                <option value="4">Brake</option>
                        ...
                        <div class="ch2_dout_input_group hidden">
                            <label>Channel 2</label>
                            <div class="input-group input-group-sm mb-3 opacity">
                                <input class="form-control form-control-sm" type="number" step="0.001" placeholder="Ch 2">
                                <div class="input-group-prepend">

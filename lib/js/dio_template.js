...
dio_template.events = function(){
    $(".ma_device").on('change', '.dio_mode_select',function () {
        ...
        switch ($(this).val()) {
            ...
            case "2":
                ...
                break;
            case "3":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_unit_label`).html('&#181s');
                break;
            case "4":
    ...
    $(".ma_device").on('change', '.dout_mode_select',function () {
        ...
        switch ($(this).val()) {
            ...
            case "3":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_dout_input_group`).removeClass('hidden');
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_dout_unit_label`).html('&#181s');
                break;
        }
    });

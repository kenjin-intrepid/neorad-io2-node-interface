    ...
    function din_channel_template(i,number)
    {
        return `
            <div class="form-group">
                ...
                <select class="form-control form-control-sm dio_mode_select_${number}" id="dio_mode_select_${number}_${index}_${i}" data-bank="${i}" data-channel="${number}">
    ...
    function dout_template(i) {
        return `
            <td class="device_channel${i} dout_channels em1" data-device="ma_device_c${i}">
                ...
                <div class="form-group neorad_enable">
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input device_check_status device_check_status_ch1" id="device_check_status_ch1_${index}_${i}" data-check="${i}" checked>
                        <label for="device_check_status_ch1_${index}_${i}" class="form-check-label ma_device_channel_status">${def_lang.text_enable}</label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="dout_ch2_group">
                    <div class="form-group neorad_enable">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input device_check_status device_check_status_ch2" id="device_check_status_ch2_${index}_${i}" data-check="${i}" checked>
                            <label for="device_check_status_ch2_${index}_${i}" class="form-check-label ma_device_channel_status">${def_lang.text_enable}</label>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            temp_template += `
                <td class="device_channel${i} em1" data-device="ma_device_c${i}" data-bank="${i}">
                    ...
                    <div class="debug_main">
                        <label for="">data[0]</label>
                        <input class="form-control form-control-sm debug_0" disabled>
                        <label for="">data[1]</label>
                        <input class="form-control form-control-sm debug_1" disabled>
                        <label for="">data[2]</label>
                        <input class="form-control form-control-sm debug_2" disabled>
                        <label for="">data[3]</label>
                        <input class="form-control form-control-sm debug_3" disabled>
                        <label for="">data[4]</label>
                        <input class="form-control form-control-sm debug_4" disabled>
                        <label for="">data[5]</label>
                        <input class="form-control form-control-sm debug_5" disabled>
                    </div>
                </td>
                `;
        }
            ...
            temp_template += `
                <td class="device_channel${i} em1" data-device="ma_device_c${i}" data-bank="${i}">
                    ...
                    <div class="ch1_dout_input_group hidden">
                        <label>Channel 1</label>
                        <div class="input-group input-group-sm mb-3 opacity">
                            <input class="form-control form-control-sm ch1_dout_unit_input" type="number" step="0.001" placeholder="Ch 1">
                            <div class="input-group-prepend">
                    ...
                    <div class="dout_ch2_group">
                        ...
                        <div class="ch2_dout_input_group hidden">
                            <label>Channel 2</label>
                            <div class="input-group input-group-sm mb-3 opacity">
                                <input class="form-control form-control-sm ch2_dout_unit_input" type="number" step="0.001" placeholder="Ch 2">
                                <div class="input-group-prepend">
...
dio_template.events = function(){
    $(".ma_device").on('change', '.dio_mode_select',function () {
        ...
        switch ($(this).val()) {
            case "1":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_unit_label`).html('');
                break;
            case "2":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_unit_label`).html('%');
                break;
            case "3":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_unit_label`).html('us');
                break;
            case "4":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_unit_label`).html('Hz');
                break;
            case "5":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_unit_label`).html('V');
                break;
        }
    });
    ...
    $(".ma_device").on('change', '.dout_mode_select',function () {
        ...
        switch ($(this).val()) {
            case "1":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_dout_input_group`).addClass('hidden');
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_dout_unit_label`).html('');
                break;
            case "2":
                $(this).parent().find('.do_freq_input_p').removeClass('hidden');
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_dout_input_group`).removeClass('hidden');
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_dout_unit_label`).html('%');
                break;
            case "3":
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_dout_input_group`).removeClass('hidden');
                $(this).parents('.ma_device_wrap').find(`.table5 .device_channel${which_bank} .ch${which_channel}_dout_unit_label`).html('us');
                break;
        }
    });
